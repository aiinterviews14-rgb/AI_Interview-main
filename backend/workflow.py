...
ALLOWED_TRANSITIONS: Dict[str, set] = {
    ...
    # Allow stepping back to resume-uploaded when profile photo changes or identity must be re-proven.
    STATE_FACE_VERIFIED: {STATE_INTERVIEW_IN_PROGRESS, STATE_RESUME_UPLOADED},
    STATE_INTERVIEW_IN_PROGRESS: {STATE_INTERVIEW_FINISHED, STATE_RESUME_UPLOADED},
